...
<body>
    ...
    <div class="crear-container">
        ...
        <?php
            if ($admin) {
                ?>
                    <button onClick="alertUploadCSV()" class="btn-style button-style" role="button" aria-disabled="true"><i class="fa-solid fa-file-arrow-up"></i> Cargar CSV</button>   
                    <div class="dropdown">
                        <button class="btn-style button-style dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <button id="multiple-mail-button" onClick="alertMultipleMail()" class=" btn-style button-style" role="button" aria-disabled="true"><i class="fa-solid fa-envelope"></i> Correo</button>
                <?php
            }
        ?>
